...
AddEventHandler('es_admin:givePosition', function()
	...
	exports.pNotify:SendNotification({text = "Position sauvegardée dans le fichier à la racine", type = "info", timeout = 10000})
end)
...
AddEventHandler("es_admin:noclip", function(t)
	...
	exports.pNotify:SendNotification({text = "NoClip à était " .. msg, type = "info", timeout = 10000})
end)
