local jobmenu = {
  ...
  menu = {
    ...
    ["main"] = {
      ...
      name = "main",
      buttons = {
        {title = "Chomeur", name = "Chomeur", id = 1}, -- ENGLISH : Minor
        {title = "Mineur", name = "Mineur", id = 2}, -- ENGLISH : Fisherman
        {title = "Fermier", name = "Fermier", id = 3}, -- ENGLISH : Taxi Driver
		{title = "Vigneron", name = "Vigneron", id = 4}, -- ENGLISH : Minor
        {title = "Convoyeur de fonds", name = "Convoyeur de fonds", id = 5}, -- ENGLISH : Minor
        {title = "Petrolier", name = "Petrolier", id = 6}, -- ENGLISH : Fisherman
        {title = "Pecheur", name = "Pecheur", id = 7}, -- ENGLISH : Taxi Driver
		{title = "Brasseur", name = "Brasseur", id = 8}, -- ENGLISH : Minor
		{title = "Bucheron", name = "Bucheron", id = 9}, -- ENGLISH : Taxi Driver
		{title = "Eleveur de poulets", name = "Eleveur de poulets", id = 10}, -- ENGLISH : Minor
      }
    },
  }
}
